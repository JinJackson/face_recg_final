...
print("初始化人脸数据字典")
dic = {}
file_dir = "F:/Study/FinalDesign/Demo/Wuenda/face_recg/face_vec"
for root, dirs, files in os.walk(file_dir):
    for file in files:
        dic[os.path.splitext(file)[0]] = np.loadtxt("face_vec/" + str(file))
print("初始化完成")
...
# save_New("images3/jzl/jzl.jpg","jzl",FRmodel)
# save_New("images3/wf/wf.jpg","wf",FRmodel)
# save_New("images3/zc/zc.jpg","zc",FRmodel)
# # save_New("images3/wzh/wzh.jpg","wzh",FRmodel)
# save_New("images3/zhb/zhb.jpg","zhb",FRmodel)
# save_New("images3/jh/jh.jpg","jh",FRmodel)
# save_New("images3/jzlN/jzlN.jpg","jzlN",FRmodel)


# save_New("gray_face/jzl.jpg","jzl",FRmodel)
# save_New("gray_face/wf.jpg","wf",FRmodel)
# save_New("gray_face/zc.jpg","zc",FRmodel)
# save_New("gray_face/wzh.jpg","wzh",FRmodel)
# save_New("gray_face/zhb.jpg","zhb",FRmodel)
# save_New("gray_face/jh.jpg","jh",FRmodel)
# save_New("gray_face/jzlN.jpg","jzlN",FRmodel)
...
#测试代码
testpic_dir = 'F:\\Study\\FinalDesign\\Demo\\Wuenda\\face_recg\\test4_highlight2'
result = []
count = 0
correct = 0
dist_all = 0
...
#     count = count + 1
#     dist, name = who_is_it(im,FRmodel)
#     print(name)
#     dist_all = dist_all + dist
#     if name == 'jzl':
#         correct = correct + 1
#     print("accuracy："+str(correct / count))
#     print("average_dist:"+str(dist_all/count))
wrong = []
for root, dirs, files in os.walk(testpic_dir):
    for file in files:
        im=root+'\\'+file
        count = count + 1
        dist, name = who_is_it(im, FRmodel)
